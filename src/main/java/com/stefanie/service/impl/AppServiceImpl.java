...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public QueryWrapper<App> getQueryWrapper(AppQueryRequest appQueryRequest) {
        ...
        queryWrapper.like(StringUtils.isNotBlank(cover), "cover", cover);
        queryWrapper.like(StringUtils.isNotBlank(initPrompt), "initPrompt", initPrompt);
        queryWrapper.eq(StringUtils.isNotBlank(codeGenType), "codeGenType", codeGenType);
        queryWrapper.eq(StringUtils.isNotBlank(deployKey), "deployKey", deployKey);
